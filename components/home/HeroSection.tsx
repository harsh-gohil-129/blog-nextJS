    ...
    <section className="relative min-h-[600px] w-full overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-indigo-950">
      ...
      <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32">
        ...
        <div className="flex-1 space-y-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row md:justify-start mt-3">
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 pt-6 text-white md:max-w-md">
        ...
        <div className="mt-12 flex-1 md:mt-0">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1516387938699-a93567ec168e?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
